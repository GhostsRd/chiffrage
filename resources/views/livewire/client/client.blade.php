<div>
    ...
    <div class="container  " style="font-size: 0.75rem">
        ...
        <div class="bg-white  rounded-3">
         ...
         <table id="user-list-table" class="table card-body  text-center rounded-1 shadow-sm  display p-2 " role="grid" data-bs-toggle="data-table">
                    <div class="row p-2">
