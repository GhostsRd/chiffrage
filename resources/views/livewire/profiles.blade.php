                      ...
                      <td><img src="{{url('images/1.png')}}" alt="" class="w-10"></td>
                        ...
                        <td class="text-center">
                            <div class="m-2 progress" style="height: 5px ;width:30%;">
                                <div class="progress-bar progress-bar-striped bg-info "  role="progressbar" style=" width:  {{  $prof->tarif /120 }}% " aria-valuemin="0" aria-valuenow=" {{ 25000 - $prof->tarif  }} " aria-valuemax="40" ></div>
                            </div>
                        </td>
