    ...
    <div class="container bg-white rounded-2 shadow-sm">
        ...
        <div class="row">
            ...
            <div class="col-6 offset-6 p-2">
             ...
             {{-- menu header --}}
            <hr>
            <h3 class="fw-bold text-warning"># List-client</h3>
                ...
                <table id="user-list-table" class="table table-light  rounded-1  display p-2 " role="grid" data-bs-toggle="data-table">
                    ...
                    <tbody>
                        ...
                        {{-- <tr>
                            ...
                            <td ><span class="badge bg-success">{{ $dat->titre}}</span></td>
                            <td>{{$dat->description}}</td>
                            <td>{{$dat->objectif}}</td>
                            <td>{{$dat->date_de_création}}</td>
                            <td >
                            <i>
                        ...
                        @foreach ($data as $dat )                           
                            <tr>
                                <td class="text-muted ">{{$dat->id}}</td>
                                <td  class="text-dark "><span class="bg-purple text-dark badge">{{$dat->nom}} </span></td>
                                <td  class="text-muted">{{$dat->description_demande}}</td>
                                <td  class="text-muted">{{$dat->prerequis}}</td>
