    ...
    <table class="  table  card-body  rounded-3 shadow-sm border-0 text-capitalize text-center   " style="border:0;overflow:hidden" >
        ...
        <thead class="">
         <th class="border-0"><input type="checkbox" ></th>
            ...
            <th class="p-2 fw-bold border-0">tarif </th>
           ...
           @foreach ($profiles as $profile)
                ...
                <tr class="border-0">
                        <td class="bg-white p-2 border-0" >
                         <input type="checkbox" wire:model="checkData" value="{{$profile->id}}" class="border-0"></td>
                    <td class="bg-white p-2 border-0" id="tdanim">{{$profile->id}}</td>
                    <td class="bg-white  p-2 border-0" id="tdanim1">{{$profile->profile}}</td>
